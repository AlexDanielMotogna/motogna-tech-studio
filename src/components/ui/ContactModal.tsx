...
export default function ContactModal({ isOpen, onClose }: ContactModalProps) {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="bg-white w-full max-w-md shadow-2xl animate-in zoom-in-95 duration-200"
      >
        ...
        <div className="p-6 space-y-4">
          ...
          >
            <div className="w-12 h-12 bg-neutral-900 flex items-center justify-center text-white group-hover:scale-105 transition-transform">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <a
            href="mailto:alex@motogna.tech?subject=Project%20Inquiry"
            className="flex items-center gap-4 p-4 border border-neutral-200 hover:border-neutral-300 hover:bg-neutral-50 transition-all group"
          >
            <div className="w-12 h-12 bg-neutral-100 flex items-center justify-center text-neutral-700 group-hover:scale-105 transition-transform">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <a
            href="https://wa.me/436601759059?text=Hi%2C%20I%27m%20interested%20in%20discussing%20a%20project"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 p-4 border border-neutral-200 hover:border-neutral-300 hover:bg-neutral-50 transition-all group"
          >
            <div className="w-12 h-12 bg-green-500 flex items-center justify-center text-white group-hover:scale-105 transition-transform">
